-- Insert listen events data into the BigQuery table
INSERT INTO {{ BIGQUERY_DATASET }}.{{ LISTEN_EVENTS_TABLE }}
SELECT
...
FROM {{ BIGQUERY_DATASET }}.{{ LISTEN_EVENTS_TABLE }}_{{ logical_date.strftime("%m%d%H") }}  -- Creates a table name with month, day, and hour
