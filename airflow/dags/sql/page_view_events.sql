-- Insert page view events data into the BigQuery table
...
FROM {{ BIGQUERY_DATASET }}.{{ PAGE_VIEW_EVENTS_TABLE }}_{{ logical_date.strftime("%m%d%H") }}  -- Creates a table name with month, day, and hour
